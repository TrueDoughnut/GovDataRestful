...
@RestController
public class ConsumerComplaintsController extends Controller {

    private static final String tag = "/ConsumerComplaints";
    public static List<Record> list;

    @RequestMapping(value = tag + "/id")
    public Object getConsumerComplaint(@RequestParam(value = "id", required = false, defaultValue = "0") int id){
